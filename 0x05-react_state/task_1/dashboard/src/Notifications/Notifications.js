...
OBOBOB    zIndex: 100,
    float: 'right',
OBOBOB    backgroundColor: '#fff8f8',
    ':hover': {
      cursor: 'pointer',
OBOBOB      animationName: [opacityAnim, bounceAnim],
...
OBOBOBNotifications.propTypes = {
  displayDrawer: PropTypes.bool,
  listNotifications: PropTypes.arrayOf(NotificationItemShape),
  handleHideDrawer: PropTypes.func,
OBOBOB  handleDisplayDrawer: PropTypes.func
};

OBOBOBexport default Notifications;
